...
func (o *UpdateEmployeeParams) WithBody(body *models.UpdateEmployeeOfficial) *UpdateEmployeeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update employee params
func (o *UpdateEmployeeParams) SetBody(body *models.UpdateEmployeeOfficial) {
	o.Body = body
}

// WithUserID adds the userID to the update employee params
func (o *UpdateEmployeeParams) WithUserID(userID string) *UpdateEmployeeParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the update employee params
func (o *UpdateEmployeeParams) SetUserID(userID string) {
	o.UserID = userID
}
